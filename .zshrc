...
zplug "plugins/wd", from:oh-my-zsh, defer:2
zplug "plugins/extract", from:oh-my-zsh, defer:2
zplug "plugins/universalarchive", from:oh-my-zsh, defer:2
...
zplug "lljbash/zsh-renew-tmux-env", defer:2
zplug "jgogstad/passwordless-history", defer:2
zplug "djui/alias-tips", defer:2
zplug "brymck/print-alias", defer:2
# vi file:123
